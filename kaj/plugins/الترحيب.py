...
@Superthon.on(events.ChatAction)
async def _(event):
...
@Superthon.ar_cmd(pattern="ترحيب(?:\s|$)([\s\S]*)")
async def save_welcome(event):
    ...
    if msg and msg.media and not string:
        ...
        string = rep_msg.text
    success = " الترحيب {} بنجاح في هذه الدردشه ."
...
@Superthon.ar_cmd(pattern="الغاء الترحيب$")
...
@Superthon.ar_cmd(pattern="الترحيبات$")
...
@Superthon.ar_cmd(pattern="الترحيب السابق (تشغيل|ايقاف)$")
async def del_welcome(event):
